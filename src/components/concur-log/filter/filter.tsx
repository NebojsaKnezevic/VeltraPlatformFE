...
export default function LogFilter(): JSX.Element {
    ...
    if (logsData.data === undefined) return <>Something went wrong with logs data...</>
        ...
        <>
            ...
            <Box sx={{ display: 'flex', gap: 2, justifyContent: 'left', mt: 2, p: 2, flexWrap: 'wrap' }} >
                ...
                <DatePicker
                    ...
                    // Donja granica je fiksna, gornja ne sme pre─çi "To" datum (ako postoji)
                    minDate={absoluteMin}
